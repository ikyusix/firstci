        ...
        <nav class="navbar top-navbar navbar-expand-md navbar-light">
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="index.html">
                    ...
                    <!--End Logo icon -->
                    <!-- Logo text -->
                    <span><img src="<?php echo base_url() ?>assets/back/images/logo-text.png" alt="homepage"
                                    ...
                                    <div class="message-center">
                                        ...
                                        <a href="#">
                                            <div class="user-img"><img
                                                        src="<?php echo base_url() ?>assets/back/images/users/5.jpg"
                                        ...
                                        <a href="#">
                                            <div class="user-img"><img
                                                        src="<?php echo base_url() ?>assets/back/images/users/2.jpg"
                                                        alt="user" class="img-circle"> <span
                                        ...
                                        <a href="#">
                                            <div class="user-img"><img
                                                        src="<?php echo base_url() ?>assets/back/images/users/3.jpg"
                                                        alt="user" class="img-circle"> <span
                                        ...
                                        <a href="#">
                                            <div class="user-img"><img
                                                        src="<?php echo base_url() ?>assets/back/images/users/4.jpg"
                                                        alt="user" class="img-circle"> <span
...
<script src="<?php echo base_url() ?>assets/back/js/jquery.slimscroll.js"></script> <!--Menu sidebar -->
